#  Virtusa Projects (Training Assignments)

This repository contains all the projects completed as part of Virtusa training.
...
###  2. Smart Expense Tracker (Python + Streamlit)
